studio.plugins.registerPluginDescription("MetaXRAudio Spatializer", {
    ...
    parameters: {
        ...
        "Dst. Override": { displayName: "Distance Override" },
    },
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                row: 1,
                                column: 0,
                                minimumBinding: "Atten. Min",
                                maximumBinding: "Atten. Max",
                                text: "Min & Max Distance",
                                maximumHeight: 64,
                            },
                            {
                                deckWidgetType: studio.ui.deckWidgetType.Button, binding: "Dst. Override",
                                row: 1,
                                column: 1,
                            },
                        ],
