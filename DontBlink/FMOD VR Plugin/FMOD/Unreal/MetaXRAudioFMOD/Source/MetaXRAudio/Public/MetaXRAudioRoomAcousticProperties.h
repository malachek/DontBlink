...
UCLASS(
    ...
    meta =
        (BlueprintSpawnableComponent,
         DisplayName = "Meta XR Audio Room Component",
         ToolTip = "Adjust the sound of the reverb in Static Room mode"),
    BlueprintType)
class METAXRAUDIO_API UMetaXRAudioRoomAcousticProperties : public UActorComponent {
 ...
 public:
  ...
  UPROPERTY(
      ...
      EditAnywhere,
      Category = Settings)
  bool bLockPositionToListener;

  // Set the room acoustics control to lock the position to the listener
  UFUNCTION(BlueprintSetter)
  void SetLockPositionToListener(bool bNewLockPositionToListener);
